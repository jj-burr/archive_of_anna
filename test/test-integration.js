...
try {
  const testMd5 = '70b53247a3fb333e1218392279c8624c'; // jim butcher storm front
  const testName = 'storm front-jim butcher.epub';
  ...
  const tests = [
    {
      ...
      params: [testMd5, testName, testPath, preferredSource]
    },
    {
  ...
  if (passedTests === totalTests) {
    ...
    console.log('  - ArchiveOfAnna.downloadByMd5(md5, name, path, preferredSource)');
    console.log('  - ArchiveOfAnna.getIpfsLinksByMd5(md5)');
    console.log('  - ArchiveOfAnna.getDownloadUrlsByMd5(md5)');
    console.log('  - ArchiveOfAnna.getAllDownloadSources(md5)');
  } else {
